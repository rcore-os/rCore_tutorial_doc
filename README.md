...
> **[info] 最后更新日期：2020-03-08**
>
> **2020-03-08**
>
> 在第九章第四小节中，MacOS 平台的同学在通过 ``dd`` 命令将 ``temp`` 文件打包到用户镜像中的时候，应该使用 ``bs=1k`` 而非 ``bs=1K`` 。在文档中已经修改，但代码没有修改。如果有 ``dd`` 命令报错的同学请注意。
>
> 对于在做 lab2/3 而 tutorial 进度已经达到第八章第二小节的同学，在练习题的主页提供了一种修改原版代码的方式，以通过评测脚本测试 lab2/3 。
>
> **2020-03-07**
>
